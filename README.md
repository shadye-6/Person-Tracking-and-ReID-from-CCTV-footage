...
5. View the processed video with tracking and identity annotations.
6. Assign names to newly detected Face IDs.
7. Download the generated logs, face database, and identity mappings.

> **Note:** The hosted application is intended for demonstration purposes. Processing speed may vary depending on server load and uploaded video size.
...
You can also use the deployed application without installing the project locally.
